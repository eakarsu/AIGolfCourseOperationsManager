...
// Auto-generated page for: No on-course mobile messaging

export default function GapNoOnCourseMobileMessaging() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-on-course-mobile-messaging', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>No on-course mobile messaging</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>No on-course mobile messaging</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run No on-course mobile messaging'}
        </button>
      </form>
