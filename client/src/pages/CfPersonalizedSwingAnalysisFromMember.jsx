...
// Auto-generated page for: Personalized swing analysis from member-uploaded video

export default function CfPersonalizedSwingAnalysisFromMember() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/cf-personalized-swing-analysis-from-member-', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>Personalized swing analysis from member-uploaded video</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>Personalized swing analysis from member-uploaded video.</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run Personalized swing analysis from member-uploaded video'}
        </button>
      </form>
