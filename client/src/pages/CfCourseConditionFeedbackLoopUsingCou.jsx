...
// Auto-generated page for: Course condition feedback loop using courseFeedback data to 

export default function CfCourseConditionFeedbackLoopUsingCou() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/cf-course-condition-feedback-loop-using-cou', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>Course condition feedback loop using courseFeedback data to </h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>Course condition feedback loop using courseFeedback data to reprioritize maintenance.</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run Course condition feedback loop using courseFeedback data to '}
        </button>
      </form>
