...
// Auto-generated page for: No payment processing surface

export default function GapNoPaymentProcessingSurface() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-payment-processing-surface', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>No payment processing surface</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>No payment processing surface</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run No payment processing surface'}
        </button>
      </form>
