...
// Auto-generated page for: No round-pairing optimization for foursome composition

export default function GapNoRoundPairingOptimizationForFourso() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-round-pairing-optimization-for-fourso', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>No round-pairing optimization for foursome composition</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>No round-pairing optimization for foursome composition</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run No round-pairing optimization for foursome composition'}
        </button>
      </form>
