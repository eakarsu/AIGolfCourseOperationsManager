...
// Auto-generated page for: Statistical leaderboard add-on for tournamentBrackets with s

export default function CfStatisticalLeaderboardAddOnForTourn() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/cf-statistical-leaderboard-add-on-for-tourn', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>Statistical leaderboard add-on for tournamentBrackets with s</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>Statistical leaderboard add-on for tournamentBrackets with shot-by-shot insights.</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run Statistical leaderboard add-on for tournamentBrackets with s'}
        </button>
      </form>
