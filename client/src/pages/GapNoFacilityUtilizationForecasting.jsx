...
// Auto-generated page for: No facility-utilization forecasting

export default function GapNoFacilityUtilizationForecasting() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-facility-utilization-forecasting', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>No facility-utilization forecasting</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>No facility-utilization forecasting</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run No facility-utilization forecasting'}
        </button>
      </form>
