...
// Auto-generated page for: No tournament-format recommender

export default function GapNoTournamentFormatRecommender() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-tournament-format-recommender', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>No tournament-format recommender</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>No tournament-format recommender</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run No tournament-format recommender'}
        </button>
      </form>
