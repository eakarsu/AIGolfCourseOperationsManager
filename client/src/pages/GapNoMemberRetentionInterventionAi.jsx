...
// Auto-generated page for: No member-retention intervention AI

export default function GapNoMemberRetentionInterventionAi() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-member-retention-intervention-ai', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>No member-retention intervention AI</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>No member-retention intervention AI</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run No member-retention intervention AI'}
        </button>
      </form>
