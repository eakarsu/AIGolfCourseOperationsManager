...
// Auto-generated page for: No real-time course status feed to members

export default function GapNoRealTimeCourseStatusFeed() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-real-time-course-status-feed', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>No real-time course status feed to members</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>No real-time course status feed to members</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run No real-time course status feed to members'}
        </button>
      </form>
