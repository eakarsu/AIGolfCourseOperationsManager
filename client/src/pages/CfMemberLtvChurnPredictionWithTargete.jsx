...
// Auto-generated page for: Member LTV + churn prediction with targeted retention offers

export default function CfMemberLtvChurnPredictionWithTargete() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/cf-member-ltv-churn-prediction-with-targete', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>Member LTV + churn prediction with targeted retention offers</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>Member LTV + churn prediction with targeted retention offers.</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run Member LTV + churn prediction with targeted retention offers'}
        </button>
      </form>
