# Governed golf-course operations
...
Versioned tee slots, capacity/pricing, bookings, maintenance closures, weather closures, rain checks, payment references and refunds.

The evaluator checks duplicate slots, overbooking, raw payment data, refund bounds, maintenance conflicts and reconciliation. Booking/POS/payment/access/weather/cart-IoT/turf/messaging adapters, device authentication, payment settlement and course-manager validation remain blocked externally.
